...
export default function SwiperHomePage() {
  ...
  return (
    <div className="bg-emerald-900" onContextMenu={(e) => e.preventDefault()}>
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        autoplay={{
      ...
      >
        <div className="absolute top-0 left-0 h-full w-full z-10 bg-black/30 flex items-center justify-center px-16 max-md:px-6">
          <h1 className=" text-green-400 text-8xl font-OpenSansExtraBold max-md:text-6xl max-sm:text-4xl cursor-context-menu select-none">
            Since 1991
          </h1>
        </div>
